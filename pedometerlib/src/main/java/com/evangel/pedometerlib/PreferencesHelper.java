...
class PreferencesHelper {
	...
	public static void setLastSensorStep(Context context,
			float lastSensorStep) {
		Logger.e(TAG, "setLastSensorStep");
		getSharedPreferences(context).edit()
				.putFloat(LAST_SENSOR_TIME, lastSensorStep).commit();
	}
	...
	public static void setStepOffset(Context context, float stepOffset) {
		...
		getSharedPreferences(context).edit().putFloat(STEP_OFFSET, stepOffset)
				.commit();
	}
	...
	public static void setStepToday(Context context, String stepToday) {
		...
		getSharedPreferences(context).edit().putString(STEP_TODAY, stepToday)
				.commit();
	}
	...
	public static void setCleanStep(Context context, boolean cleanStep) {
		...
		getSharedPreferences(context).edit().putBoolean(CLEAN_STEP, cleanStep)
				.commit();
	}
	...
	public static void setCurrentStep(Context context, float currStep) {
		...
		getSharedPreferences(context).edit().putFloat(CURR_STEP, currStep)
				.commit();
	}
	...
	public static void setShutdown(Context context, boolean shutdown) {
		...
		getSharedPreferences(context).edit().putBoolean(SHUTDOWN, shutdown)
				.commit();
	}
	...
	public static void setElapsedRealtime(Context context,
			long elapsedRealtime) {
		Logger.e(TAG, "setElapsedRealtime");
		getSharedPreferences(context).edit()
				.putLong(ELAPSED_REALTIMEl, elapsedRealtime).commit();
	}
